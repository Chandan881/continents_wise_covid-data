...
fetch('https://vaccovid-coronavirus-vaccine-and-treatment-tracker.p.rapidapi.com/api/npm-covid-data/europe', options)
    ...
    <div className="ritmid">
      <div className="headr">
        <div className="searchHead">
          <h1 className="livup">
            Europe Data <span className="smllsiz">-Live update</span>
          </h1>
          <input
            className="inptst"
            type="text"
